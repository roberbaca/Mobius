...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Moebius Space Force", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Moebius Space Force", null, 480, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Moebius Space Force";
		app.meta["name"] = "Moebius Space Force";
